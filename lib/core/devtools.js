...
exports.Protocol = safeRequire(devtools,
  "devtools/shared/protocol",
  "devtools/server/protocol"
);

exports.ActorRegistryFront = safeRequire(devtools,
  "devtools/shared/fronts/actor-registry",
  "devtools/server/actors/actor-registry"
).ActorRegistryFront;
