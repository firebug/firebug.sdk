...
/** @lends TreeView */
{
  ...
  render: function() {
    ...
    /*console.log("TreeView.render; rows", {
      rows: rows,
      state: state
    });*/
  ...
  componentDidMount: function() {
    console.log("TreeView.componentDidMount", this.props);
  ...
  componentWillReceiveProps: function(nextProps) {
    ...
    console.log("TreeView.componentWillReceiveProps; update: " +
      update, nextProps);
  ...
  initMembers: function(parent, level) {
    ...
    //console.log("TreeView.initMembers; " + level, parent);
  ...
  fetchMembers: function(object, level) {
    ...
    console.log("TreeView.fetchMembers;", children);
...
var TreeRow = React.createFactory(React.createClass({
  ...
  render: function() {
    ...
    /*console.log("TreeRow.render; " + member.name, {
      member: member,
      value: value,
    });*/
