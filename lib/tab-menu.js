...
/** @lends TabMenu */
{
  ...
  initialize: function(panel, doc, tabIdPrefix, owner) {
    ...
    // The panel can be instance of {@BasePanel} or {@BaseOverlay}.
    this.panel = panel;
  ...
  onSelectPanel: function(eventId, panelId) {
    ...
    let id = this.panel.overlayId || this.panel.id;
    if (panelId != id) {
      return;
    }
...
/** @lends TabMenuBox */
{
  ...
  createTabMenu: function() {
    ...
    this.tabMenu = new TabMenu(this.panel, this.toolbox.doc,
  ...
  onPanelShow: function() {
    ...
    if (ToolboxChrome.getCurrentTheme() == "firebug") {
      this.createTabMenu();
    }
  },
